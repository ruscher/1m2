...
//        title : 'Rafael Modern Residence in New York',
...
//        title : 'Rafael Hauntingly Beautiful Estate',
...
//        title : 'Rafael Sophisticated Residence',
...
//        title : 'Rafael House With a Lovely Glass-Roofed Pergola',
        ...
        $.each(props, function(i,prop) {
            ...
            var infoboxContent = '<div class="infoW">' +
                                    ...
                                    '<ul class="propFeat">' +
                                        ...
                                        '<li><span class="fa fa-bed"></span> ' + prop.bedrooms + '</li>' +

                                        '<li><span class="fa fa-bath"></span> ' + prop.bathrooms + '</li>' +

                                        '<li><span class="fa fa-shower"></span> ' + prop.shower + '</li>' +
    ...
    $('.priceSlider').slider({
        ...
        slide: function(event, ui) {
            ...
            $('.priceSlider .sliderTooltip .stLabel').html(
				...
				//if(ui.values[0].toString()<=10000000){'mais'}else{'menos'}; + 
			...
			//colocar + quando chegano no maximo

			if(ui.values[1]>='5000000'){ 

				//alert('oi! Valor:' + ui.values[1]);
...
//By Rafael m2 min e max
    ...
    $('.volume .btn-round-right').click(function() {
		...
		//	$(this).siblings('input').val(currentVal + 1) + 'mais';
