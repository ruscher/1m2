(function($) {
    ...
    var props = [{
        ...
        type : 'For Rent',
        price : '$3,333,333',
        address : 'SHIN CA 5, Brasília, DF 71503-505, BRA',
        bedrooms : '2',
        bathrooms : '2',
        area : '2750 Sq Ft',
        position : {
            lat : -15.759620457790211,
...
//            });
			...
			//RAFAEL INICIO marker clusterer
    ...
    setTimeout(function() {
        ...
        if ($('#home-map').length > 0) {
            ...
            map.setCenter(new google.maps.LatLng(-15.71703348814601,-47.88460392799453));
            map.setZoom(14);
