...
//}
$resultadoimovel_view = mysql_query($sqlimovel_view);

while ($linhaimovel_view=mysql_fetch_array($resultadoimovel_view)) {
	$sqllista_proprietario = "SELECT * FROM mapa WHERE id_imovel='".$linhaimovel_view['id_imovel']."'";
	$resultadolista_proprietario = mysql_query($sqllista_proprietario);
	$linhalista_proprietario=mysql_fetch_array($resultadolista_proprietario);
